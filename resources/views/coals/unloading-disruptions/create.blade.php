            ...
            <div class="flex items-end justify-between mb-2">
                <div>
                    ...
                    <div class="mb-4 text-[16px] text-[#6C757D] font-normal no-select">
                        <a href="{{ route('administration.dashboard') }}">Home</a> / <a href="{{ route('coals.unloadings.disruptions.index',['unloadingId' => $unloading->id]) }}" class="cursor-pointer">Pembongkaran Batu Bara</a> / <span class="text-[#2E46BA] cursor-pointer">Create</span>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg p-6">
                <form onsubmit="return confirmSubmit(this, 'Tambahkan Pembongkaran Batu Bara ?')" action="{{ route('coals.unloadings.disruptions.store',['unloadingId' => $unloading->id]) }}" method="POST">
                    @csrf
                        <div class="unloadings">
                            <div class="p-4 bg-white rounded-lg w-full">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <select name="group_disruption" id="group_disruption" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            ...
                                            <option>UBP Suralaya</option>
                                            <option>Gangguan Kapal</option>
                                        </select>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input required type="datetime-local" name="start_disruption_date" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input required type="datetime-local" name="end_disruption_date" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <a href="{{route('coals.unloadings.disruptions.index',['unloadingId' => $unloading->id])}}" class="bg-[#C03221] text-center w-full lg:w-[300px] py-3 text-[white] text-[16px] font-semibold rounded-lg mt-3 px-3">Back</a>
