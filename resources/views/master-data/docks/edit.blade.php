                    ...
                    <div class="p-4 bg-white rounded-lg w-full">
                        ...
                        <div class="lg:flex items-center justify-between">
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <input type="text" name="load_rate" value="{{ old('load_rate') ? old('load_rate') : $dock->load_rate }}" class="w-full lg:w-[300px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                    @error('load_rate')
                                    <div class="absolute -bottom-1 left-1 text-red-500">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="lg:flex items-center justify-between">
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <input type="text" name="duration_before_load" value="{{ old('duration_before_load') ? old('duration_before_load') : $dock->duration_before_load }}" class="w-full lg:w-[300px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <input type="text" name="duration_after_load" value="{{ old('duration_after_load') ? old('duration_after_load') : $dock->duration_after_load }}" class="w-full lg:w-[300px] border rounded-md mt-3 mb-5 h-[40px] px-3">
