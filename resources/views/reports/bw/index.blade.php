...
<div x-data="{sidebar:true}" class="w-screen overflow-hidden flex bg-[#E9ECEF]">
    ...
    <div class="max-h-screen overflow-hidden" :class="sidebar?'w-10/12' : 'w-full'">
            ...
            <div class="flex items-end justify-between mb-2">
                <div>
                    ...
                    <div class="text-[16px] text-[#6C757D] font-normal no-select">
                        <a href="{{ route('administration.dashboard') }}">Home</a> / <span class="text-[#2E46BA] cursor-pointer">Laporan</span> / <span class="text-[#2E46BA] cursor-pointer">BW</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="w-full max-w-[600px] flex flex-col gap-4 my-4 mt-4 px-8">
            @php
                $dataReport = [
                    ['text' => 'Laporan Data BW Berdasarkan Kapal','url' => '#'],
                    ['text' => 'Laporan Data BW Berdasarkan Shift & Dermaga','url' => '#'],
                ]
            @endphp
