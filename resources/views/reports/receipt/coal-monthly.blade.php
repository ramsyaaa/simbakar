                        ...
                        <tbody>
                            @foreach ($coals as $coal)
                                <tr>
                                    ...
                                    <td class="border border-gray-400 p-2 text-center">{{$coal->duration_time}}</td>
                                    ...
                                    <td class="border border-gray-400 p-2 text-center">{{number_format($coal->bw)}}</td>
                                    <td class="border border-gray-400 p-2 text-right">{{number_format($coal->tug_3_accept)}}</td>
                                    <td class="border border-gray-400 p-2 text-center">{{$coal->dock->name ?? ''}}</td>
                            ...
                            <tr>
                                ...
                                <td class="border border-slate-900 font-bold p-2 text-center"> {{number_format($coals->sum('duration_time'))}}</td>
                                ...
                                <td class="border border-slate-900 font-bold p-2 text-center"> {{number_format($coals->sum('bw'))}}</td>
