    ...
    <div class="max-h-screen overflow-hidden" :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-20 px-8 max-h-screen hide-scrollbar overflow-y-auto">
            ...
            <div class="bg-white rounded-lg p-6">
                <form onsubmit="return confirmSubmit(this, 'Ubah Transfer BBM ?')" action="{{ route('contracts.bbm-transfers.update',['id'=> $bbm->id]) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="p-4 bg-white rounded-lg w-full">
                            ...
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <select name="kind_bbm" id="kind_bbm" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        ...
                                        <option value="solar" {{ $bbm->kind_bbm == "solar" ? 'selected' : '' }}>Solar / HSD</option>
                                        <option value="residu" {{ $bbm->kind_bbm == 'residu' ? 'selected' : '' }}> Residu</option>
                                    </select>
                                    @error('kind_bbm')
                        ...
                        <div class="lg:flex gap-4">
                            <div class="source">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="number" name="start_level_source" value="{{ $bbm->start_level_source }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="number" name="end_level_source" value="{{ $bbm->end_level_source }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="number" name="start_sounding_source" value="{{ $bbm->start_sounding_source }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="number" name="end_sounding_source" value="{{ $bbm->end_sounding_source }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="destination">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input type="number" name="start_level_destination" value="{{ $bbm->start_level_destination }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input type="number" name="end_level_destination" value="{{ $bbm->end_level_destination }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input type="number" name="start_sounding_destination" value="{{ $bbm->start_sounding_destination }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input type="number" name="end_sounding_destination" value="{{ $bbm->end_sounding_destination }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="number" name="ba_number" value="{{ $bbm->ba_number }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('ba_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="date" name="transfer_date" value="{{ $bbm->transfer_date }}" class="w-full lg:w-96 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('transfer_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <button class="bg-[#2E46BA] w-full lg:w-[300px] py-3 text-[white] text-[16px] font-semibold rounded-lg mt-3">Ubah Transfer BBM </button>
                    </div>
                </form>
            </div>
        </div>
