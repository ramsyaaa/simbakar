    ...
    <div :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-10 px-8">
            ...
            <div class="bg-white rounded-lg p-6">
                <form onsubmit="return confirmSubmit(this, 'Tambahkan Spesifikasi Kontrak Baru ?')" action="{{ route('contracts.biomassa-contracts.spesification.store',['contractId'=>$contract->id]) }}" method="POST">
                    @csrf
                    ...
                    <small class="text-slate-700"> Untuk angka koma gunakan titik .</small>
                        ...
                        <div class="w-full py-1 flex gap-3">
                            <div class="airdried_moisure">
                                ...
                                <div class="relative">
                                    <input type="text" name="moisure_in_analysis_min" value="{{ old('moisure_in_analysis_min') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Moisure in Analysis Min">
                            ...
                            <div class="moisure_in_analysis">
                                ...
                                <div class="relative">
                                    <input type="text" name="moisure_in_analysis_max" value="{{ old('moisure_in_analysis_max') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Moisure in Analysis Max">
                            ...
                            <div class="moisure_in_analysis">
                                ...
                                <div class="relative">
                                    <input type="text" name="moisure_in_analysis_typical" value="{{ old('moisure_in_analysis_typical') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Moisure in Analysis Typical">
                        ...
                        <div class="w-full py-1 flex gap-3">
                            <div class="volatile_matter">
                                ...
                                <div class="relative">
                                    <input type="text" name="size_distribution_min" value="{{ old('size_distribution_min') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Size Distribution Min">
                            ...
                            <div class="size_distribution">
                                ...
                                <div class="relative">
                                    <input type="text" name="size_distribution_max" value="{{ old('size_distribution_max') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Size Distribution Max">
                            ...
                            <div class="size_distribution">
                                ...
                                <div class="relative">
                                    <input type="text" name="size_distribution_typical" value="{{ old('size_distribution_typical') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Size Distribution Max">
                        ...
                        <div class="bg-sky-600 py-1 text-center text-xl text-white mb-3 rounded">Butiran</div>
                          ...
                          <div class="w-full py-1 flex gap-3">
                            <div class="retained_5">
                                ...
                                <div class="relative">
                                    <input type="text" name="retained_5_min" value="{{ old('retained_5_min') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Retained 5 Min">
                            ...
                            <div class="retained_5">
                                ...
                                <div class="relative">
                                    <input type="text" name="retained_5_max" value="{{ old('retained_5_max') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Retained 5 Max">
                            ...
                            <div class="retained_5">
                                ...
                                <div class="relative">
                                    <input type="text" name="retained_5_typical" value="{{ old('retained_5_typical') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Retained 5 Typical">
                        ...
                        <div class="w-full py-1 flex gap-3">
                            <div class="retained_238">
                                ...
                                <div class="relative">
                                    <input type="text" name="retained_238_min" value="{{ old('retained_238_min') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Retained 2.38 Min">
                            ...
                            <div class="retained_238">
                                ...
                                <div class="relative">
                                    <input type="text" name="retained_238_max" value="{{ old('retained_238_max') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Retained 2.38 Max">
                            ...
                            <div class="retained_238">
                                ...
                                <div class="relative">
                                    <input type="text" name="retained_238_typical" value="{{ old('retained_238_typical') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Retained 2.38 Typical">
                        ...
                        <div class="w-full py-1 flex gap-3">
                            <div class="passing_238">
                                ...
                                <div class="relative">
                                    <input type="text" name="passing_238_min" value="{{ old('passing_238_min') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Passing 2.38 Min">
                            ...
                            <div class="passing_238">
                                ...
                                <div class="relative">
                                    <input type="text" name="passing_238_max" value="{{ old('passing_238_max') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Passing 2.38 Max">
                            ...
                            <div class="passing_238">
                                ...
                                <div class="relative">
                                    <input type="text" name="passing_238_typical" value="{{ old('passing_238_typical') }}" class="input-number w-full lg:w-72 border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="Passing 5 Typical">
