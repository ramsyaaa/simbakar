    ...
    <div :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-10 px-8">
            <div class="flex items-end justify-between mb-2">
                <div>
                    <div class="text-[#135F9C] text-[40px] font-bold">
                        Ubah Klausul Penyesuaian Kontrak Biomassa
                    </div>
            ...
            <div class="bg-white rounded-lg p-6">
                ...
                <form onsubmit="return confirmSubmit(this, 'Ubahk Klausul Penyesuaian Kontrak Baru ?')" action="{{ route('contracts.biomassa-contracts.adjusment-clause.update',['contractId'=>$contract->id,'id'=>$adjusment->id]) }}" method="POST">
                    @csrf
                    @method('PATCH')
