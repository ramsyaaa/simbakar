            ...
            <div class="flex items-end justify-between mb-2">
                <div>
                    <div class="text-[#135F9C] text-[40px] font-bold">
                        List Spesifikasi kontrak Batu Bara {{ nomor kontrak}}
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="h-[36px] text-[16px] font-normal border px-2 ">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('contracts.coal-contracts.spesification.edit', ['id' => $coal->id]) }}" class="bg-[#1AA053] text-center text-white w-[80px] h-[25px] text-[16px] rounded-md">
                                            Edit
                                        </a>
                                        <form onsubmit="return confirmSubmit(this, 'Hapus Data?')" action="{{ route('contracts.coal-contracts.destroy', ['id' => $coal->id]) }}" method="POST">
                                            @csrf
                                            @method('delete')
