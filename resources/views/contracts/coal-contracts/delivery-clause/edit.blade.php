    ...
    <div :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-10 px-8">
            ...
            <div class="bg-white rounded-lg p-6">
                ...
                <form onsubmit="return confirmSubmit(this, 'Ubah Klausul Pengiriman Kontrak Baru ?')" action="{{ route('contracts.coal-contracts.delivery-clause.update',['contractId'=>$contract->id,'id'=>$delivery->id]) }}" method="POST">
                    @csrf
                    @method('PATCH')
