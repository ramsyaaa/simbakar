    ...
    <div :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-10 px-8">
            <div class="flex items-end justify-between mb-2">
                <div>
                    <div class="text-[#135F9C] text-[40px] font-bold">
                        Tambah Denda Penolakan Kontrak Batu Bara
                    </div>
            ...
            <div class="bg-white rounded-lg p-6">
                ...
                <form onsubmit="return confirmSubmit(this, 'Tambahkan Denda Penolakan Kontrak Baru ?')" action="{{ route('contracts.coal-contracts.penalty-clause.store',['contractId'=>$contract->id]) }}" method="POST">
                    @csrf
                    ...
                    <small class="text-slate-700"> Untuk angka koma gunakan titik .</small>
                        <div class="w-full py-1 flex gap-3">
                            ...
                            <div class="delivery">
                                ...
                                <div class="relative">
                                    <input type="text" name="penalty_will_get_if_number" value="{{ old('penalty_will_get_if_number') }}" class="input-number w-full lg:w-[360px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                        ...
                        <div class="w-full py-1 flex gap-3">
                            ...
                            <div class="delivery">
                                ...
                                <div class="relative">
                                    <input type="text" name="penalty_price_number" value="{{ old('penalty_price_number') }}" class="input-number w-full lg:w-[360px] border rounded-md mt-3 mb-5 h-[40px] px-3">
