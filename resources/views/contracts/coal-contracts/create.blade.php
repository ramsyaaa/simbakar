                ...
                <form onsubmit="return confirmSubmit(this, 'Tambahkan Data Kontrak Batubara?')" action="{{ route('contracts.coal-contracts.store') }}" method="POST">
                    ...
                    <div class="p-4 bg-white rounded-lg w-full">
                        ...
                        <div class="w-full py-1">
                            ...
                            <div class="relative">
                                <input type="text" name="total_volume" value="{{ old('total_volume') }}" class="format-number w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                @error('total_volume')
                                <div class="absolute -bottom-1 left-1 text-red-500">
                                    {{ $message }}
                                </div>
                        ...
                        <button class="bg-[#2E46BA] w-full lg:w-[300px] py-3 text-[white] text-[16px] font-semibold rounded-lg mt-3">Tambah Kontrak Batu Bara</button>
                    </div>
                </form>
            </div>
        </div>
