    ...
    <div :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-10 px-8">
            <div class="flex items-end justify-between mb-2">
                <div>
                    <div class="text-[#135F9C] text-[40px] font-bold">
                        Edit Adendum Kontrak Batu Bara
                    </div>
            ...
            <div class="bg-white rounded-lg p-6">
                <form onsubmit="return confirmSubmit(this, 'Edit Spesifikasi Kontrak Baru ?')" action="{{ route('contracts.adendum-coal-contracts.spesification.update',['adendumId'=>$adendum->id,'id'=>$coal->id]) }}" method="POST">
                    @csrf
                    @method('PATCH')
