    ...
    <div :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-10 px-8">
            ...
            <div class="bg-white rounded-lg p-6">
                ...
                <form onsubmit="return confirmSubmit(this, 'Tambahkan Klausul Pengiriman Kontrak Baru ?')" action="{{ route('contracts.adendum-coal-contracts.delivery-clause.store',['adendumId'=>$adendum->id]) }}" method="POST">
                    @csrf
