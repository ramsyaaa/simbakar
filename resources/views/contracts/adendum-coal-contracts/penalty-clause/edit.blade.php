    ...
    <div class="max-h-screen overflow-hidden" :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-20 px-8 max-h-screen hide-scrollbar overflow-y-auto">
            <div class="flex items-end justify-between mb-2">
                <div>
                    <div class="text-[#135F9C] text-[40px] font-bold">
                        Ubah Adendum Denda Penolakan Kontrak Batu Bara
                    </div>
            ...
            <div class="bg-white rounded-lg p-6">
                ...
                <form onsubmit="return confirmSubmit(this, 'Ubah Denda Penolakan Kontrak Baru ?')" action="{{ route('contracts.adendum-coal-contracts.penalty-clause.update',['adendumId'=>$adendum->id,'id'=>$penalty->id]) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <small class="text-slate-700"> Untuk angka koma gunakan titik .</small>
                        ...
                        <div class="flex gap-3">
                            <a href="{{route('contracts.adendum-coal-contracts.penalty-clause.index',['adendumId'=>$adendum->id])}}" class="bg-[#C03221] w-full h-full lg:w-[300px] py-3 text-[white] text-[16px] font-semibold rounded-lg mt-3 px-3 text-center">Back</a>
