    ...
    <div :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-10 px-8">
            <div class="flex items-end justify-between mb-2">
                <div>
                    <div class="text-[#135F9C] text-[40px] font-bold">
                        Tambah Adendum Denda Penolakan Kontrak Batu Bara
                    </div>
                    <div class="mb-4 text-[16px] text-[#6C757D] font-normal no-select">
                        <a href="{{ route('administration.dashboard') }}">Home</a> <a href="{{ route('contracts.adendum-coal-contracts.index',['contractId' => $adendum->contract_id]) }}" class="cursor-pointer">  <a href="{{ route('contracts.adendum-coal-contracts.index',['contractId' => $adendum->contract_id]) }}"> / Kontrak Batu Bara  <a href="{{ route('contracts.adendum-coal-contracts.penalty-clause.index',['adendumId' => $adendum->id]) }}"> / Denda Penolakan Kontrak Batu Bara / </a> <span class="text-[#2E46BA] cursor-pointer">{{$contract->contract_number}}</span>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg p-6">
                ...
                <form onsubmit="return confirmSubmit(this, 'Tambahkan Denda Penolakan Kontrak Baru ?')" action="{{ route('contracts.adendum-coal-contracts.penalty-clause.store',['adendumId'=>$adendum->id]) }}" method="POST">
                    @csrf
                    ...
                    <small class="text-slate-700"> Untuk angka koma gunakan titik .</small>
                        <div class="w-full py-1 flex gap-3">
                            ...
                            <div class="delivery">
                                ...
                                <div class="relative">
                                    <input type="text" name="penalty_will_get_if_number" value="{{ old('penalty_will_get_if_number') }}" class="input-number w-full lg:w-64 border rounded-md mt-3 mb-5 h-[40px] px-3">
                        ...
                        <div class="w-full py-1 flex gap-3">
                            ...
                            <div class="delivery">
                                ...
                                <div class="relative">
                                    <input type="text" name="penalty_price_number" value="{{ old('penalty_price_number') }}" class="input-number w-full lg:w-64 border rounded-md mt-3 mb-5 h-[40px] px-3">
                        ...
                        <div class="flex gap-3">
                            <a href="{{route('contracts.adendum-coal-contracts.penalty-clause.index',['adendumId'=>$adendum->contract_id])}}" class="bg-[#C03221] w-full h-full lg:w-[300px] py-3 text-[white] text-[16px] font-semibold rounded-lg mt-3 px-3 text-center">Back</a>
