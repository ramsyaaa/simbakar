    ...
    <div class="max-h-screen overflow-hidden" :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-20 px-8 max-h-screen hide-scrollbar overflow-y-auto">
            ...
            <div class="bg-white rounded-lg p-6">
                ...
                <form onsubmit="return confirmSubmit(this, 'Ubahk Klausul Penyesuaian Kontrak Baru ?')" action="{{ route('contracts.adendum-coal-contracts.adjusment-clause.update',['adendumId'=>$adendum->id,'id'=>$adjusment->id]) }}" method="POST">
                    @csrf
                    @method('PATCH')
