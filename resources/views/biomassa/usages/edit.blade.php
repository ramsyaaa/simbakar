    ...
    <div class="max-h-screen overflow-hidden" :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-20 px-8 max-h-screen hide-scrollbar overflow-y-auto">
            ...
            <div class="bg-white rounded-lg p-6">
                <form onsubmit="return confirmSubmit(this, 'Ubah Pemakaian Biomassa ?')" action="{{ route('biomassa.usages.update',['id'=>$usage->id]) }}" method="POST">
                    @csrf
                    @method('PATCH')
                            ...
                            <div class="p-4 bg-white rounded-lg w-full">
                                ...
                                <div class="lg:flex gap-3">
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input required type="text" name="amount_use" value="{{ old('amount_use', $usage->amount_use) }}"  class="w-full lg:w-46 border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                            @error('amount_use')
                                            <div class="absolute -bottom-1 left-1 text-red-500">
                                                {{ $message }}
                                            </div>
