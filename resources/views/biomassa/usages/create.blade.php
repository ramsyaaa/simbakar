                            ...
                            <div class="p-4 bg-white rounded-lg w-full">
                                <div class="lg:flex gap-3">
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input required type="text" name="tug_9_number" class="w-full lg:w-46 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            @error('tug_9_number')
                                ...
                                <div class="lg:flex gap-3">
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input required type="text" name="amount_use" class="w-full lg:w-46 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            @error('amount_use')
                                            <div class="absolute -bottom-1 left-1 text-red-500">
                                                {{ $message }}
                                            </div>
