                    ...
                    <div class="p-4 bg-white rounded-lg w-full">
                        <div class="lg:flex gap-4 items-center justify-between">
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <input type="text" name="name" value="{{ old('name') ? old('name') : $user->name }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                    @error('name')
                            ...
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <input type="text" name="username" value="{{ old('username') ? old('username') : $user->username }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                    @error('username')
                                    <div class="absolute -bottom-1 left-1 text-red-500">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="lg:flex gap-4 items-center justify-between">
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <input type="email" name="email" value="{{ old('email') ? old('email') : $user->email }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                    @error('email')
                                    <div class="absolute -bottom-1 left-1 text-red-500">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <input type="text" name="nid" value="{{ old('nid') ? old('nid') : $user->nid }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                    @error('nid')
                                    <div class="absolute -bottom-1 left-1 text-red-500">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="lg:flex gap-4 items-center justify-between">
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <select name="role_id" id="role_id" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
