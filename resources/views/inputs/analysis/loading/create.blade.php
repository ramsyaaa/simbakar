                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="start_loading" value="{{ old('start_loading') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('start_loading')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="end_loading" value="{{ old('end_loading') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('end_loading')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="bill_of_ladding" value="{{ old('bill_of_ladding') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
