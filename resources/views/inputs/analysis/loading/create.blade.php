                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="date" name="start_loading" value="{{ old('start_loading') }}" class="w-full border rounded-md h-[24px] px-3">
                                        @error('start_loading')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="date" name="end_loading" value="{{ old('end_loading') }}" class="w-full border rounded-md h-[24px] px-3">
                                        @error('end_loading')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="bill_of_ladding" value="{{ old('bill_of_ladding') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="hgi" value="{{ old('hgi') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('hgi')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
