                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="calorivic_value" value="{{ old('calorivic_value', $loading->calorivic_value ?? '') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="initial_deformation" value="{{ old('initial_deformation', $loading->initial_deformation ?? '') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="softening" value="{{ old('softening', $loading->softening ?? '') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('softening')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="hemispherical" value="{{ old('hemispherical', $loading->hemispherical ?? '') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('hemispherical')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="fluid" value="{{ old('fluid', $loading->fluid ?? '') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('fluid')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
