                    ...
                    <div class="p-4 bg-white rounded-lg w-full">
                        <div class="w-full">
                            ...
                            <div class="w-6/12 flex items-center mt-2">
                                ...
                                <div class="relative w-8/12">
                                    <select name="surveyor_uuid" id="surveyor_uuid" class="select-2 w-full border rounded-md mt-3 mb-5 h-[24px] px-3">
                                        <option value="">Pilih</option>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="datetime-local" name="start_unloading" value="{{ old('start_unloading') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3">
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="datetime-local" name="end_unloading" value="{{ old('end_unloading') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3">
                                        @error('end_unloading')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="analysis_number" value="{{ old('analysis_number') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3">
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="date" name="analysis_date" value="{{ old('analysis_date') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3">
                                        @error('analysis_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="moisture_total" value="{{ old('moisture_total') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="air_dried_moisture" value="{{ old('air_dried_moisture') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="ash" value="{{ old('ash') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('ash')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="volatile_matter" value="{{ old('volatile_matter') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="fixed_carbon" value="{{ old('fixed_carbon') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('fixed_carbon')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="total_sulfur" value="{{ old('total_sulfur') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('total_sulfur')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="calorivic_value" value="{{ old('calorivic_value') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="carbon" value="{{ old('carbon') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('carbon')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="hydrogen" value="{{ old('hydrogen') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('hydrogen')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="nitrogen" value="{{ old('nitrogen') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('nitrogen')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="oxygen" value="{{ old('oxygen') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('oxygen')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="initial_deformation" value="{{ old('initial_deformation') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="softening" value="{{ old('softening') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('softening')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="hemispherical" value="{{ old('hemispherical') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('hemispherical')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="fluid" value="{{ old('fluid') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('fluid')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="sio2" value="{{ old('sio2') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('sio2')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="al2o3" value="{{ old('al2o3') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('al2o3')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="fe2o3" value="{{ old('fe2o3') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('fe2o3')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="cao" value="{{ old('cao') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('cao')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="mgo" value="{{ old('mgo') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('mgo')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="na2o" value="{{ old('na2o') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('na2o')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="k2o" value="{{ old('k2o') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('k2o')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="tlo2" value="{{ old('tlo2') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('tlo2')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="so3" value="{{ old('so3') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('so3')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="p2o5" value="{{ old('p2o5') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('p2o5')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="mn3o4" value="{{ old('mn3o4') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('mn3o4')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="butiran_70" value="{{ old('butiran_70') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('butiran_70')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="butiran_50" value="{{ old('butiran_50') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('butiran_50')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="butiran_32_50" value="{{ old('butiran_32_50') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('butiran_32_50')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="butiran_32" value="{{ old('butiran_32') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('butiran_32')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="butiran_238" value="{{ old('butiran_238') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('butiran_238')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="hgi" value="{{ old('hgi') }}" class="w-full border rounded-md mt-3 mb-5 h-[24px] px-3 format-number">
                                        @error('hgi')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
