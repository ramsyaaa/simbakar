    ...
    <div :class="sidebar?'w-10/12' : 'w-full'">
        ...
        <div class="w-full py-10 px-8">
            ...
            <div class="bg-white rounded-lg p-6">
                <form onsubmit="return confirmSubmit(this, 'Ubahkan Stock Opname?')" action="{{ route('inputs.stock-opnames.update',['uuid' => $stock->uuid]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="p-4 bg-white rounded-lg w-full">
                        <div class="w-full">
                            ...
                            <div class="relative">
                                <input type="date" name="measurement_date" value="{{ $stock->measurement_date }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative">
                                <input type="number" name="stock_opname" value="{{ $stock->stock_opname }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                @error('stock_opname')
                                <div class="absolute -bottom-1 left-1 text-red-500">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative">
                                <input type="number" name="loose_density" value="{{ $stock->loose_density }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                @error('loose_density')
                                <div class="absolute -bottom-1 left-1 text-red-500">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative">
                                <input type="number" name="compact_density" value="{{ $stock->compact_density }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
