                            ...
                            <div class="p-4 bg-white rounded-lg w-full">
                                <div class="lg:flex gap-3">
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input required type="date" value="{{$tug->usage_date}}" name="usage_date" class="w-full lg:w-46 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            @error('usage_date')
                                ...
                                <div class="lg:flex gap-3">
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input required type="text" value="{{$tug->amount_use}}" name="usage_amount" class="w-full lg:w-46 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            @error('usage_amount')
                                            <div class="absolute -bottom-1 left-1 text-red-500">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="relative">
                                            <input required type="text" value="{{$tug->tug_9_number}}" name="ba_number" class="w-full lg:w-46 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            @error('ba_number')
                                            <div class="absolute -bottom-1 left-1 text-red-500">
                                                {{ $message }}
                                            </div>
                    ...
                    <div class="mx-auto my-10 bg-white p-8 rounded">
                        <table class="w-full border-collapse border border-gray-900">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border border-gray-900 p-8">{{number_format($tug->amount_use)}}</td>
                                    <td class="border border-gray-900 p-8">Kg</td>
                                    <td class="border border-gray-900 p-8">Batu Bara</td>
                                    <td class="border border-gray-900 p-8">18.01.0009</td>
