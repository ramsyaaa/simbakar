                        ...
                        <div class="w-full">
                                ...
                                <div class="relative">
                                    <select name="load_company_uuid" id="load_company_uuid" class="select-2 w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        ...
                                        @foreach ($load_companies as $item)
                                            <option value="{{ $item->uuid }}" {{ old('load_company_uuid') == $item->uuid ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="relative">
                                        <select name="port_origin" id="port_origin" class="select-2 w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            ...
                                            @foreach ($harbors as $item)
                                                <option value="{{ $item->uuid }}" {{ old('port_origin') == $item->uuid ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('port_origin')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <select name="destination_port" id="destination_port" class="select-2 w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            <option value="">Pilih</option>
                                            @foreach ($harbors as $item)
                                                <option value="{{ $item->uuid }}" {{ old('destination_port') == $item->uuid ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="relative">
                                        <select name="dock" id="dock" class="select-2 w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            ...
                                            @foreach ($docks as $item)
                                                <option value="{{ $item->uuid }}" {{ old('dock') == $item->uuid ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('dock')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                    ...
                                    <div class="relative">
                                        <select name="ship_agent_uuid" id="ship_agent_uuid" class="select-2 w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            ...
                                            @foreach ($ship_agents as $item)
                                                <option value="{{ $item->uuid }}" {{ old('ship_agent_uuid') == $item->uuid ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="w-full flex gap-4">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="captain" value="{{ old('captain') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('captain')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="car_type" value="{{ old('car_type') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('car_type')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="police_number" value="{{ old('police_number') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('police_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="relative">
                                        <select name="transporter_uuid" id="transporter_uuid" class="select-2 w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            ...
                                            @foreach ($transporters as $item)
                                                <option value="{{ $item->uuid }}" {{ old('transporter_uuid') == $item->uuid ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="w-full flex gap-4">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="load_date" value="{{ old('load_date') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('load_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="arrival_date" value="{{ old('arrival_date') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('arrival_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="docked_date" value="{{ old('docked_date') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('docked_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="unload_date" value="{{ old('unload_date') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('unload_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="finish_date" value="{{ old('finish_date') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('finish_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="departure_date" value="{{ old('departure_date') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="string" name="note" value="{{ old('note') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('note')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="faktur_obs" value="{{ old('faktur_obs') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('faktur_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="faktur_ltr15" value="{{ old('faktur_ltr15') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('faktur_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            {{-- <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ubl_obs" value="{{ old('ubl_obs') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('ubl_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ubl_ltr15" value="{{ old('ubl_ltr15') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('ubl_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ual_obs" value="{{ old('ual_obs') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('ual_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ual_ltr15" value="{{ old('ual_ltr15') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('ual_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ubd_obs" value="{{ old('ubd_obs') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('ubd_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ubd_ltr15" value="{{ old('ubd_ltr15') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('ubd_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="uad_obs" value="{{ old('uad_obs') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('uad_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="uad_ltr15" value="{{ old('uad_ltr15') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('uad_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="vol_level_awal_obs" value="{{ old('vol_level_awal_obs') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="vol_level_akhir_abs" value="{{ old('vol_level_akhir_abs') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="vol_level_awal_ltr15" value="{{ old('vol_level_awal_ltr15') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="vol_level_akhir_ltr15" value="{{ old('vol_level_akhir_ltr15') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="hasil_sond_awal" value="{{ old('hasil_sond_awal') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="hasil_sond_akhir" value="{{ old('hasil_sond_akhir') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="flow_meter_awal" value="{{ old('flow_meter_awal') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="flow_meter_akhir" value="{{ old('flow_meter_akhir') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="liter_15_tug3" value="{{ old('liter_15_tug3') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3 format-number">
                                        @error('liter_15_tug3')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input disabled type="text" name="tug3_number" value="{{ old('tug3_number') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3" placeholder="diisi otomatis">
                                        @error('tug3_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="date" name="date_receipt" value="{{ old('date_receipt') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('date_receipt')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="norm_number" value="{{ old('norm_number') }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('norm_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="unit" value="{{ old('unit') }}" value="Liter" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('unit')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <select name="inspector" id="inspector" class="select-2-tag select-inspection w-full lg:w-46 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full lg:w-6/12">
                                    ...
                                    <div class="relative">
                                        <select name="head_of_warehouse" id="head_of_warehouse" class="select-2-tag select-warehouse w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
