            ...
            <div class="flex items-end justify-between mb-2">
                <div>
                    ...
                    <div class="mb-4 text-[16px] text-[#6C757D] font-normal no-select">
                         <a href="{{ route('administration.dashboard') }}">Home</a> / <a href="{{ route('inputs.bbm_receipts.index') }}">Penerimaan BBM</a> / <span class="text-[#2E46BA] cursor-pointer">Update</span>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg p-6">
                <form onsubmit="return confirmSubmit(this, 'Edit Penerimaan BBM?')" action="{{ route('inputs.bbm_receipts.update', ['id' => $bbm->id]) }}" method="POST">
                    @method('put')
                    @csrf
                    <div class="p-4 bg-white rounded-lg w-full">
                        <div class="w-full">
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <select name="shipment_type" id="shipment_type" onchange="toggleShipmentType()" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        ...
                                        <option value="ship" {{ old('shipment_type', $bbm->shipment_type ?? '') == "ship" ? 'selected' : '' }}>Kapal</option>
                                        <option value="car" {{ old('shipment_type', $bbm->shipment_type ?? '') == "car" ? 'selected' : '' }}>Mobil</option>
                                    </select>
                                    @error('shipment_type')
                            ...
                            <div class="w-full">
                                ...
                                <div class="relative">
                                    <select name="load_company_uuid" id="load_company_uuid" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        <option value="">Pilih</option>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="bpb_number" value="{{ old('bpb_number', $bbm->bpb_number ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('bpb_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="order_number" value="{{ old('order_number', $bbm->order_number ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('order_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="faktur_number" value="{{ old('faktur_number', $bbm->faktur_number ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('faktur_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <select name="ship_agent_uuid" id="ship_agent_uuid" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            <option value="">Pilih</option>
                            ...
                            <div class="w-full flex">
                                ...
                                <div class="w-full only-ship">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="captain" value="{{ old('captain', $bbm->captain ?? '') }}}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('captain')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full only-car">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="car_type" value="{{ old('car_type', $bbm->car_type ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('car_type')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full only-car">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="police_number" value="{{ old('police_number', $bbm->police_number ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('police_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <select name="transporter_uuid" id="transporter_uuid" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                            <option value="">Pilih</option>
                            ...
                            <div class="w-full flex">
                                <div class="w-full only-ship">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="load_date" value="{{ old('load_date', $bbm->load_date ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('load_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full only-ship">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="arrival_date" value="{{ old('arrival_date', $bbm->arrival_date ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('arrival_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full only-ship">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="docked_date" value="{{ old('docked_date', $bbm->docked_date ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('docked_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="unload_date" value="{{ old('unload_date', $bbm->unload_date ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('unload_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="finish_date" value="{{ old('finish_date', $bbm->finish_date ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('finish_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full only-ship">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="departure_date" value="{{ old('departure_date', $bbm->departure_date ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="string" name="note" value="{{ old('note', $bbm->note ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('note')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="faktur_obs" value="{{ old('faktur_obs', $bbm->faktur_obs ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('faktur_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="faktur_ltr15" value="{{ old('faktur_ltr15', $bbm->faktur_ltr15 ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('faktur_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ubl_obs" value="{{ old('ubl_obs', $bbm->ubl_obs ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('ubl_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ubl_ltr15" value="{{ old('ubl_ltr15', $bbm->ubl_ltr15 ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('ubl_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ual_obs" value="{{ old('ual_obs', $bbm->ual_obs ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('ual_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ual_ltr15" value="{{ old('ual_ltr15', $bbm->ual_ltr15 ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('ual_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ubd_obs" value="{{ old('ubd_obs', $bbm->ubd_obs ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('ubd_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="ubd_ltr15" value="{{ old('ubd_ltr15', $bbm->ubd_ltr15 ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('ubd_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="uad_obs" value="{{ old('uad_obs', $bbm->uad_obs ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('uad_obs')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="uad_ltr15" value="{{ old('uad_ltr15', $bbm->uad_ltr15 ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('uad_ltr15')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="vol_level_awal_obs" value="{{ old('vol_level_awal_obs', $bbm->vol_level_awal_obs ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="vol_level_akhir_abs" value="{{ old('vol_level_akhir_abs', $bbm->vol_level_akhir_abs ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="vol_level_awal_ltr15" value="{{ old('vol_level_awal_ltr15', $bbm->vol_level_awal_ltr15 ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="vol_level_akhir_ltr15" value="{{ old('vol_level_akhir_ltr15', $bbm->vol_level_akhir_ltr15 ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="hasil_sond_awal" value="{{ old('hasil_sond_awal', $bbm->hasil_sond_awal ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="hasil_sond_akhir" value="{{ old('hasil_sond_akhir', $bbm->hasil_sond_akhir ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="flow_meter_awal" value="{{ old('flow_meter_awal', $bbm->flow_meter_awal ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="flow_meter_akhir" value="{{ old('flow_meter_akhir', $bbm->flow_meter_akhir ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="liter_15_tug3" value="{{ old('liter_15_tug3', $bbm->liter_15_tug3 ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('liter_15_tug3')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="tug3_number" value="{{ old('tug3_number', $bbm->tug3_number ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('tug3_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="date" name="date_receipt" value="{{ old('date_receipt', $bbm->date_receipt ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('date_receipt')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="norm_number" value="{{ old('norm_number', $bbm->norm_number ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('norm_number')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="unit" value="{{ old('unit', $bbm->unit ?? '') }}" value="Liter" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('unit')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="amount_receipt" value="{{ old('amount_receipt', $bbm->amount_receipt ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="inspector" value="{{ old('inspector', $bbm->inspector ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('inspector')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="head_of_warehouse" value="{{ old('head_of_warehouse', $bbm->head_of_warehouse ?? '') }}" class="w-full lg:w-[600px] border rounded-md mt-3 mb-5 h-[40px] px-3">
