                        ...
                        <div class="w-full mb-3">
                            <div class="w-full flex gap-4">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="analysis_number" value="{{ $analytic->analysis_number }}" class="w-full border rounded-md mt-3 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="date" name="analysis_date" value="{{ $analytic->analysis_date }}" class="w-full border rounded-md mt-3 h-[40px] px-3">
                                        @error('analysis_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full">
                            <div class="w-full flex gap-4">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="start_date" value="{{ $analytic->start_date }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('start_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="end_date" value="{{ $analytic->end_date }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('end_date')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full">
                            <div class="w-full flex gap-4">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="number" name="tonage" value="{{ $analytic->tonage }}" class="w-full lg:w-1/2 border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('tonage')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="total_moisure" value="{{ $analytic->total_moisure }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('total_moisure')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="moisure_in_analysis" value="{{ $analytic->moisure_in_analysis }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="calorivic_value" value="{{ $analytic->calorivic_value }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="size_distribution" value="{{ $analytic->size_distribution }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="retained_5" value="{{ $analytic->retained_5 }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('retained_5')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="retained_238" value="{{ $analytic->retained_238 }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('retained_238')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-full">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="passing_238" value="{{ $analytic->passing_238 }}" class="w-full border rounded-md mt-3 mb-5 h-[40px] px-3">
                                        @error('passing_238')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
