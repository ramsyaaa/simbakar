            ...
            <div class="flex items-end justify-between mb-2">
                <div>
                    <div class="text-[#135F9C] text-[40px] font-bold">
                        Tambah Analisa Sebelum Pembongkaran
                    </div>
                    <div class="mb-4 text-[16px] text-[#6C757D] font-normal no-select">
                        <a href="{{ route('administration.dashboard') }}">Home</a> / <a href="{{ route('inputs.analysis-bbm.befores.index') }}">Analisa</a> / <a href="{{ route('inputs.analysis-bbm.befores.index') }}" class="cursor-pointer">Sebelum Bongkar</a>  / <span class="text-[#2E46BA] cursor-pointer">Create</span>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg p-6">
                <form onsubmit="return confirmSubmit(this, 'Tambahkan Analisa?')" action="{{ route('inputs.analysis-bbm.befores.store') }}" method="POST">
                    @csrf
                    <div class="p-4 bg-white rounded-lg w-full">
                        <div class="w-full flex gap-4">
                            <div class="w-6/12 flex items-center mt-2 gap-2">
                                <label for="order_number" class="w-4/12 font-bold text-[#232D42] text-[16px]">No Faktur Penerimaan</label>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="density" value="{{ old('density') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('density')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="spesific_gravity" value="{{ old('spesific_gravity') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="kinematic_viscosity" value="{{ old('kinematic_viscosity') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                ...
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="sulfur_content" value="{{ old('sulfur_content') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="flash_point" value="{{ old('flash_point') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('flash_point')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="pour_point" value="{{ old('pour_point') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('pour_point')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="carbon_residu" value="{{ old('carbon_residu') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('carbon_residu')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="water_content" value="{{ old('water_content') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('water_content')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="fame_content" value="{{ old('fame_content') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('fame_content')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="ash_content" value="{{ old('ash_content') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('ash_content')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="sediment_content" value="{{ old('sediment_content') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                ...
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="calorific_value" value="{{ old('calorific_value') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="sodium" value="{{ old('sodium') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('sodium')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="potassium" value="{{ old('potassium') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('potassium')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-full flex gap-4">
                                <div class="w-6/12 flex items-center mt-2 gap-2">
                                    ...
                                    <div class="relative w-8/12">
                                        <input type="text" name="vanadium" value="{{ old('vanadium') }}" class="w-full border rounded-md h-[24px] px-3 format-number">
                                        @error('vanadium')
                                        <div class="absolute -bottom-1 left-1 text-red-500">
                                            {{ $message }}
                                        </div>
                        ...
                        <a href="{{ route('inputs.analysis-bbm.befores.index') }}" class="bg-[#C03221] w-full lg:w-[300px] py-3 text-[white] text-[16px] font-semibold rounded-lg mt-3 px-3">Back</a>
