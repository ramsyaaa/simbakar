<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
        <i class="icon" data-bs-toggle="tooltip" title="Administrasi" data-bs-placement="right">
    ...
    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
        <li class="nav-item">
            <a class="nav-link " href="{{route('admin.user.index')}}">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="User" data-bs-placement="right">
                    U </i>
        ...
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Approval Data" data-bs-placement="right"> A </i>
                <span class="item-name">Approval Data</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Log Aktifitas User" data-bs-placement="right"> L </i>
                <span class="item-name">Log Aktifitas User</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="{{route('admin.role.index')}}">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Role" data-bs-placement="right"> R </i>
