<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#kontrak-menu" role="button" aria-expanded="false" aria-controls="kontrak-menu">
        <i class="icon" data-bs-toggle="tooltip" title="kontrak Data" data-bs-placement="right">
    ...
    <ul class="sub-nav collapse" id="kontrak-menu" data-bs-parent="#sidebar-menu">
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Batu Bara" data-bs-placement="right">
                    B </i>
                <span class="item-name"> Batu Bara </span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Pemesanan BBM" data-bs-placement="right"> P </i>
                <span class="item-name">Pemesanan BBM</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Transfer BBM" data-bs-placement="right"> T </i>
                <span class="item-name">Transfer BBM</span>
            </a>
        </li>
    </ul>
</li>
