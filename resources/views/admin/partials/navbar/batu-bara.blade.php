<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#batu-bara-menu" role="button" aria-expanded="false" aria-controls="batu-bara-menu">
        <i class="icon" data-bs-toggle="tooltip" title="batu-bara Data" data-bs-placement="right">
    ...
    <ul class="sub-nav collapse" id="batu-bara-menu" data-bs-parent="#sidebar-menu">
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Pembongkaran" data-bs-placement="right">
                    P </i>
        ...
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Pemakaian" data-bs-placement="right"> P </i>
