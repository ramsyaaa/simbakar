<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#bbm-menu" role="button" aria-expanded="false" aria-controls="bbm-menu">
        <i class="icon" data-bs-toggle="tooltip" title="bbm Data" data-bs-placement="right">
    ...
    <ul class="sub-nav collapse" id="bbm-menu" data-bs-parent="#sidebar-menu">
        <li class="nav-item">
