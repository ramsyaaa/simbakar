<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#kapal-menu" role="button" aria-expanded="false" aria-controls="kapal-menu">
        <i class="icon" data-bs-toggle="tooltip" title="kapal Data" data-bs-placement="right">
    ...
    <ul class="sub-nav collapse" id="kapal-menu" data-bs-parent="#sidebar-menu">
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Jadwal" data-bs-placement="right"> J </i>
        ...
        <li class="nav-item">
            <a class="nav-link " href="#">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Pemantauan" data-bs-placement="right"> P </i>
                <span class="item-name">Pemantauan</span>
            </a>
        </li>
    </ul>
</li>
