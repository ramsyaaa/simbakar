        ...
        <div class="w-full py-20 px-8 max-h-screen hide-scrollbar overflow-y-auto">
            ...
            <div x-data="{ selectedFuel: 'solar', solar: true, residu: false }" class="bg-white rounded-lg p-6">
                <div class="lg:flex items-center justify-between gap-2 w-full mb-3">
                    <form x-data="{ submitForm: function() { document.getElementById('filterForm').submit(); } }" x-on:change="submitForm()" action="{{ route('initial-data.bbm-receipt-plan.index') }}" method="GET" id="filterForm">
                    ...
                    <div class="mb-2 lg:mb-0">
                        <select x-model="selectedFuel" @change="solar = selectedFuel === 'solar'; residu = selectedFuel === 'residu';" name="year" id="" class="w-full lg:w-[200px] h-[44px] text-[19px] text-[#8A92A6] border rounded-md">
                ...
                <div class="overflow-auto hide-scrollbar max-w-full">
                    ...
                    <table x-cloak x-show="solar" class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="border  bg-[#F5F6FA] h-[52px] text-[#8A92A6]">Rencana Penerimaan Solar (Liter)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <table x-cloak x-show="residu" class="w-full">
                        <thead>
                            <tr>
                                <th class="border  bg-[#F5F6FA] h-[52px] text-[#8A92A6]">Bulan</th>
                                <th class="border  bg-[#F5F6FA] h-[52px] text-[#8A92A6]">Rencana Penerimaan Residu (Liter)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
