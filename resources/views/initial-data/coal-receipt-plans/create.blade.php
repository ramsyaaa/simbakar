            ...
            <div class="flex items-end justify-between mb-2">
                <div>
                    <div class="mb-4 text-[16px] text-[#6C757D] font-normal no-select">
                        <a href="{{ route('administration.dashboard') }}">Home</a> / <a href="{{ route('initial-data.coal-receipt-plan.index') }}" class="cursor-pointer">Rencana Penerimaan Batubara</a> / <span class="text-[#2E46BA] cursor-pointer">Create</span>
                    </div>
                </div>
            </div>
            <form action="{{ route('initial-data.coal-receipt-plan.store') }}" method="POST">
                @csrf
