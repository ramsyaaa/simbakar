@if (Auth::user()->hasPermissionTo('administration-user') || Auth::user()->hasPermissionTo('administration-approval') || Auth::user()->hasPermissionTo('administration-log') || Auth::user()->hasPermissionTo('administration-role'))
   @php
       $isOpen = false;

       if(
            request()->routeIs('administration.users.index') ||
            request()->routeIs('administration.roles.index')
            ){
                $isOpen = true;
            }
   @endphp
                ...
                <div class="flex items-center gap-4 ">
                    <div>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M18 22C18 18.6863 15.3137 16 12 16C8.68629 16 6 18.6863 6 22" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path opacity="0.4" d="M21 22C21 17.5817 17.4183 14 13 14C12.4536 14 11.9274 14.0557 11.426 14.1604C12.3022 15.233 13 17.1418 13 19.25V22H21Z" fill="#ffffff"/>
                            <path d="M16.5 6C16.5 6.82843 15.8284 7.5 15 7.5C14.1716 7.5 13.5 6.82843 13.5 6C13.5 5.17157 14.1716 4.5 15 4.5C15.8284 4.5 16.5 5.17157 16.5 6Z" fill="#ffffff"/>
                        </svg>
                ...
                @if (Auth::user()->hasPermissionTo('administration-user'))
                    <div>
                        <a href="{{route('administration.users.index')}}">
                            <div class="flex items-center gap-4 py-2 cursor-pointer hover:scale-105 duration-300 hover:bg-[#047A96] {{ request()->routeIs('administration.users.index') ? 'bg-[#047A96]' : 'hover:bg-[#047A96]' }} rounded-lg">
                                <div>
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @if (Auth::user()->hasPermissionTo('administration-role'))
                    <div>
                        <a href="{{route('administration.roles.index')}}">
                            <div class="flex items-center gap-4 py-2 cursor-pointer hover:scale-105 duration-300 hover:bg-[#047A96] {{ request()->routeIs('administration.roles.index') ? 'bg-[#047A96]' : 'hover:bg-[#047A96]' }} rounded-lg">
                                <div>
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="12" cy="12.0005" r="5" fill="#ffffff"/>
                                    </svg>
