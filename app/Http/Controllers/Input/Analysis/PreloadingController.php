...
class PreloadingController extends Controller
{
    public function index(Request $request)
    {
        $preloadings = Preloadinng::query();

        $preloadings->when($request->year, function ($query) use ($request) {
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'tonase.required' => 'Tonase wajib diisi',
        ...
        return redirect(route('inputs.analysis.preloadings.index'))->with('success', 'Preloading baru baru berhasil dibuat.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('inputs.analysis.preloadings.index'))->with('success', 'Preloading berhasil diubah.');
    }
    ...
    {
        Preloadinng::where('id',$id)->first()->delete();

        return redirect(route('inputs.analysis.preloadings.index'))->with('success', 'Preloading berhasil dihapus.');
    }
}
