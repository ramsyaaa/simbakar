...
class CreateAdendumAdjusmentClausesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('adendum_adjusment_clauses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('adendum_adjusment_clauses');
    }
}
