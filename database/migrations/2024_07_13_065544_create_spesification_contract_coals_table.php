...
class CreateSpesificationContractCoalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('spesification_contract_coals', function (Blueprint $table) {
            ...
            $table->float('tio2_min')->nullable();
            $table->float('tio2_max')->nullable();
            $table->float('tio2_typical')->nullable();
    ...
    {
        Schema::dropIfExists('spesification_contract_coals');
    }
}
