...
class CreatePreloadinngsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('preloadinngs', function (Blueprint $table) {
            $table->id();
            $table->string('contract_uuid')->nunllable();
            $table->string('surveyor_uuid')->nunllable();
            $table->string('analysis_number')->nullable();
            $table->date('analysis_date')->nullable();
            $table->string('tonase')->nullable();
            $table->string('origin_of_goods')->nullable();
    ...
    {
        Schema::dropIfExists('preloadinngs');
    }
}
