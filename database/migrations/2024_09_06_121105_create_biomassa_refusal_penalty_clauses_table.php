...
class CreateBiomassaRefusalPenaltyClausesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('biomassa_refusal_penalty_clauses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('biomassa_refusal_penalty_clauses');
    }
}
